...
/* Creates a custom marker icon based on visit count */
const createCustomIcon = (visits) => {
  ...
  const fontSize =
    width > 40 ? "14px" : width > 35 ? "13px" : width > 30 ? "12px" : "11px";
...
/* MapController Component - Handles map focusing and zoom control cleanup */
